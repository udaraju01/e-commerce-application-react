                ...
                <div className='row'>
                    <div className='col-6'>
                        ...
                        <div className='other-products-images d-flex flex-wrap gap-15'>
                            <div>
                                <img src={product.image} alt='watch' className='img-fluid'/>
                            </div>
                            <div>
                        ...
                        <div className='main-product-details'>
                            ...
                            <div className='border-bottom py-3'>
                                ...
                                <div className='d-flex gap-10 flex-column my-3'>
                                    <h3 className='product-heading'>About:</h3>
                                    <p className='product-data text-dark'>{product.about}
                                    </p>
                                </div>
...
export default OurStoreSinglePage
